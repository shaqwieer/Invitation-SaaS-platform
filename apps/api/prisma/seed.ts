...
const GUESTS: SeedGuest[] = [
  { name: 'أ. فيصل السبيعي', phone: '+966554128830', group: GROOM, companionsAllowed: 3, companionsConfirmed: 3, status: 'CONFIRMED' },
  { name: 'م. نورة القحطاني', phone: '+966507331120', group: FRIENDS, companionsAllowed: 2, companionsConfirmed: 1, status: 'CONFIRMED' },
  { name: 'عائلة الدوسري', phone: '+966539904471', group: NEIGHBOURS, companionsAllowed: 4, companionsConfirmed: 0, status: 'DECLINED' },
  { name: 'د. سلطان العتيبي', phone: '+966550182264', group: WORK, companionsAllowed: 3, companionsConfirmed: 0, status: 'SENT' },
  { name: 'أ. منيرة الشمري', phone: '+966562279013', group: BRIDE, companionsAllowed: 2, companionsConfirmed: 0, status: 'NOT_SENT' },
  { name: 'عبدالله بن ماجد', phone: '+966596643308', group: GROOM, companionsAllowed: 1, companionsConfirmed: 0, status: 'NOT_SENT' },
  { name: 'هيا بنت طلال', phone: '+966548817702', group: FRIENDS, companionsAllowed: 3, companionsConfirmed: 2, status: 'ATTENDED' },
  { name: 'أ. ريم الزهراني', phone: '+966551002233', group: FRIENDS, companionsAllowed: 2, companionsConfirmed: 1, status: 'CONFIRMED' },
  { name: 'م. بدر السهلي', phone: '+966553441199', group: WORK, companionsAllowed: 1, companionsConfirmed: 0, status: 'CONFIRMED' },
  { name: 'عائلة الغامدي', phone: '+966505778341', group: NEIGHBOURS, companionsAllowed: 5, companionsConfirmed: 4, status: 'CONFIRMED' },
  { name: 'أ. خالد بن عمر', phone: '+966561209987', group: GROOM, companionsAllowed: 2, companionsConfirmed: 0, status: 'DECLINED' },
  { name: 'لطيفة بنت سعد', phone: '+966558830012', group: BRIDE, companionsAllowed: 3, companionsConfirmed: 2, status: 'CONFIRMED' },
  { name: 'د. ماجد الحربي', phone: '+966502211764', group: WORK, companionsAllowed: 1, companionsConfirmed: 0, status: 'SENT' },
  { name: 'أ. سارة الحربي', phone: '+966547719920', group: FRIENDS, companionsAllowed: 2, companionsConfirmed: 0, status: 'SENT' },
  { name: 'عائلة القرني', phone: '+966559003471', group: NEIGHBOURS, companionsAllowed: 4, companionsConfirmed: 3, status: 'CONFIRMED' },
  { name: 'م. تركي الشهري', phone: '+966533388201', group: GROOM, companionsAllowed: 2, companionsConfirmed: 1, status: 'CONFIRMED' },
  { name: 'أ. جواهر المطيري', phone: '+966566120945', group: BRIDE, companionsAllowed: 3, companionsConfirmed: 0, status: 'OPENED' },
  { name: 'عبدالرحمن بن فهد', phone: '+966504467788', group: WORK, companionsAllowed: 1, companionsConfirmed: 1, status: 'CONFIRMED' },
  { name: 'أ. أسماء العنزي', phone: '+966557712306', group: FRIENDS, companionsAllowed: 2, companionsConfirmed: 0, status: 'NOT_SENT' },
  { name: 'عائلة البقمي', phone: '+966598821140', group: BRIDE, companionsAllowed: 4, companionsConfirmed: 0, status: 'NOT_SENT' },
];
